...
const envSchema = z.object({
  ...
  BROWSER_SUBSCRIPTION_SEARCH_TRUSTED_DIRECTUS_CLIENT_KEYS: z.string().default("graphql-api"),
  ...
  NOTIFICATION_INTAKE_TRUSTED_DIRECTUS_CLIENT_KEYS: z.string().default("graphql-api"),
