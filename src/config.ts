...
const envSchema = z.object({
  ...
  BROWSER_SUBSCRIPTION_CLEANUP_STARTUP_RETRY_INTERVAL_MS: z.string().default("30000"),
  BROWSER_SUBSCRIPTION_CLEANUP_STARTUP_MAX_ATTEMPTS: z.string().default("20"),
  ...
  NOTIFICATION_REQUEST_RECONCILE_STARTUP_RETRY_INTERVAL_MS: z.string().default("30000"),
  NOTIFICATION_REQUEST_RECONCILE_STARTUP_MAX_ATTEMPTS: z.string().default("20"),
...
export const config = {
  ...
  browserSubscriptionCleanupStartupRetryIntervalMs: Math.max(5_000, Number(parsed.BROWSER_SUBSCRIPTION_CLEANUP_STARTUP_RETRY_INTERVAL_MS) || 30_000),
  browserSubscriptionCleanupStartupMaxAttempts: Math.max(1, Math.min(100, Number(parsed.BROWSER_SUBSCRIPTION_CLEANUP_STARTUP_MAX_ATTEMPTS) || 20)),
  ...
  notificationRequestReconcileStartupRetryIntervalMs: Math.max(5_000, Number(parsed.NOTIFICATION_REQUEST_RECONCILE_STARTUP_RETRY_INTERVAL_MS) || 30_000),
  notificationRequestReconcileStartupMaxAttempts: Math.max(1, Math.min(100, Number(parsed.NOTIFICATION_REQUEST_RECONCILE_STARTUP_MAX_ATTEMPTS) || 20)),
